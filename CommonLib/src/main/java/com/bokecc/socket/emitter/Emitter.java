package com.bokecc.socket.emitter;
...
public class Emitter {
    ...
    private AllEventListener allEventListener;

    /**
     * 设置所有事件监听
     * @param allEventListener
     */
    public void setAllEventListener(AllEventListener allEventListener){
