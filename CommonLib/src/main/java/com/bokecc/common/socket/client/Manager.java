...
import com.bokecc.common.socket.parser.IOParser;
import com.bokecc.common.socket.parser.Packet;
import com.bokecc.common.socket.parser.Parser;
import com.bokecc.common.socket.backo.Backoff;
...
public class Manager extends Emitter {
    ...
    /*package*/ com.bokecc.common.socket.engineio.client.Socket engine;
    ...
    public Manager open(final OpenCallback fn) {
        EventThread.exec(new Runnable() {
            ...
            public void run() {
                ...
                final com.bokecc.common.socket.engineio.client.Socket socket = Manager.this.engine;
    ...
    private void onopen() {
        ...
        final com.bokecc.common.socket.engineio.client.Socket socket = this.engine;
    ...
    private static class Engine extends com.bokecc.common.socket.engineio.client.Socket {
    ...
    public static class Options extends com.bokecc.common.socket.engineio.client.Socket.Options {
