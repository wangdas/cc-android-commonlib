package com.bokecc.common.socket.engineio.client.transports;
...
import com.bokecc.common.socket.engineio.client.Transport;
import com.bokecc.common.socket.engineio.parser.Packet;
import com.bokecc.common.socket.engineio.parser.Parser;
import com.bokecc.common.socket.parseqs.ParseQS;
import com.bokecc.common.socket.thread.EventThread;
import com.bokecc.common.socket.utf8.UTF8Exception;
import com.bokecc.common.socket.yeast.Yeast;
...
public class WebSocket extends Transport {
    ...
    private com.bokecc.okhttp.WebSocket ws;
    ...
    protected void doOpen() {
        ...
        com.bokecc.okhttp.WebSocket.Factory factory = webSocketFactory != null ? webSocketFactory : new OkHttpClient();
        ...
        ws = factory.newWebSocket(request, new WebSocketListener() {
            @Override
            public void onOpen(com.bokecc.okhttp.WebSocket webSocket, Response response) {
            ...
            @Override
            public void onMessage(com.bokecc.okhttp.WebSocket webSocket, final String text) {
                if (text == null) {
                    return;
                }
                EventThread.exec(new Runnable() {
            ...
            @Override
            public void onMessage(com.bokecc.okhttp.WebSocket webSocket, final ByteString bytes) {
                if (bytes == null) {
                    return;
                }
                EventThread.exec(new Runnable() {
            ...
            @Override
            public void onClosed(com.bokecc.okhttp.WebSocket webSocket, int code, String reason) {
                EventThread.exec(new Runnable() {
                    @Override
                    public void run() {
                        self.onClose();
            ...
            @Override
            public void onFailure(com.bokecc.okhttp.WebSocket webSocket, final Throwable t, Response response) {
