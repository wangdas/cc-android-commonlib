...
import com.bokecc.glide.load.DecodeFormat;
import com.bokecc.glide.load.ImageHeaderParser;
import com.bokecc.glide.load.ResourceDecoder;
import com.bokecc.glide.load.Transformation;
import com.bokecc.glide.load.data.InputStreamRewinder;
import com.bokecc.glide.load.engine.Engine;
import com.bokecc.glide.load.engine.bitmap_recycle.ArrayPool;
import com.bokecc.glide.load.engine.bitmap_recycle.BitmapPool;
import com.bokecc.glide.load.engine.cache.DiskCache;
import com.bokecc.glide.load.engine.cache.MemoryCache;
import com.bokecc.glide.load.engine.prefill.BitmapPreFiller;
import com.bokecc.glide.load.engine.prefill.PreFillType;
import com.bokecc.glide.load.model.AssetUriLoader;
import com.bokecc.glide.load.model.ByteArrayLoader;
import com.bokecc.glide.load.model.ByteArrayLoader.ByteBufferFactory;
import com.bokecc.glide.load.model.ByteBufferEncoder;
import com.bokecc.glide.load.model.ByteBufferFileLoader.Factory;
import com.bokecc.glide.load.model.DataUrlLoader;
import com.bokecc.glide.load.model.FileLoader;
import com.bokecc.glide.load.model.GlideUrl;
import com.bokecc.glide.load.model.MediaStoreFileLoader;
import com.bokecc.glide.load.model.ResourceLoader.AssetFileDescriptorFactory;
import com.bokecc.glide.load.model.ResourceLoader.FileDescriptorFactory;
import com.bokecc.glide.load.model.ResourceLoader.StreamFactory;
import com.bokecc.glide.load.model.ResourceLoader.UriFactory;
import com.bokecc.glide.load.model.StreamEncoder;
import com.bokecc.glide.load.model.StringLoader;
import com.bokecc.glide.load.model.UnitModelLoader;
import com.bokecc.glide.load.model.UriLoader;
import com.bokecc.glide.load.model.UrlUriLoader;
import com.bokecc.glide.load.model.stream.HttpGlideUrlLoader;
import com.bokecc.glide.load.model.stream.HttpUriLoader;
import com.bokecc.glide.load.model.stream.MediaStoreImageThumbLoader;
import com.bokecc.glide.load.model.stream.MediaStoreVideoThumbLoader;
import com.bokecc.glide.load.model.stream.UrlLoader;
import com.bokecc.glide.load.resource.bitmap.BitmapDrawableDecoder;
import com.bokecc.glide.load.resource.bitmap.BitmapDrawableEncoder;
import com.bokecc.glide.load.resource.bitmap.BitmapEncoder;
import com.bokecc.glide.load.resource.bitmap.ByteBufferBitmapDecoder;
import com.bokecc.glide.load.resource.bitmap.DefaultImageHeaderParser;
import com.bokecc.glide.load.resource.bitmap.Downsampler;
import com.bokecc.glide.load.resource.bitmap.ExifInterfaceImageHeaderParser;
import com.bokecc.glide.load.resource.bitmap.ResourceBitmapDecoder;
import com.bokecc.glide.load.resource.bitmap.StreamBitmapDecoder;
import com.bokecc.glide.load.resource.bitmap.UnitBitmapDecoder;
import com.bokecc.glide.load.resource.bitmap.VideoDecoder;
import com.bokecc.glide.load.resource.bytes.ByteBufferRewinder;
import com.bokecc.glide.load.resource.drawable.ResourceDrawableDecoder;
import com.bokecc.glide.load.resource.drawable.UnitDrawableDecoder;
import com.bokecc.glide.load.resource.file.FileDecoder;
import com.bokecc.glide.load.resource.gif.ByteBufferGifDecoder;
import com.bokecc.glide.load.resource.gif.GifDrawable;
import com.bokecc.glide.load.resource.gif.GifDrawableEncoder;
import com.bokecc.glide.load.resource.gif.GifFrameResourceDecoder;
import com.bokecc.glide.load.resource.gif.StreamGifDecoder;
import com.bokecc.glide.load.resource.transcode.BitmapBytesTranscoder;
import com.bokecc.glide.load.resource.transcode.BitmapDrawableTranscoder;
import com.bokecc.glide.load.resource.transcode.DrawableBytesTranscoder;
import com.bokecc.glide.load.resource.transcode.GifDrawableBytesTranscoder;
import com.bokecc.glide.manager.ConnectivityMonitorFactory;
import com.bokecc.glide.manager.RequestManagerRetriever;
import com.bokecc.glide.module.GlideModule;
import com.bokecc.glide.module.ManifestParser;
import com.bokecc.glide.request.RequestListener;
import com.bokecc.glide.request.RequestOptions;
import com.bokecc.glide.request.target.ImageViewTargetFactory;
import com.bokecc.glide.request.target.Target;
import com.bokecc.glide.util.Preconditions;
import com.bokecc.glide.util.Util;
...
public class Glide implements ComponentCallbacks2 {
  ...
  Glide(
    ...
    StreamFactory resourceLoaderStreamFactory =
        new StreamFactory(resources);
    UriFactory resourceLoaderUriFactory =
        new UriFactory(resources);
    FileDescriptorFactory resourceLoaderFileDescriptorFactory =
        new FileDescriptorFactory(resources);
    AssetFileDescriptorFactory resourceLoaderAssetFileDescriptorFactory =
        new AssetFileDescriptorFactory(resources);
    ...
    registry
        ...
        .append(File.class, ByteBuffer.class, new Factory())
        ...
        .append(byte[].class, ByteBuffer.class, new ByteBufferFactory())
