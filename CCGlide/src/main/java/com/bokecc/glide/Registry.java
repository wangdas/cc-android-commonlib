...
import com.bokecc.glide.load.data.DataRewinder;
import com.bokecc.glide.load.data.DataRewinder.Factory;
import com.bokecc.glide.load.data.DataRewinderRegistry;
import com.bokecc.glide.load.engine.DecodePath;
import com.bokecc.glide.load.engine.LoadPath;
...
import com.bokecc.glide.load.model.ModelLoaderRegistry;
import com.bokecc.glide.load.resource.gif.GifDrawable;
import com.bokecc.glide.load.resource.transcode.ResourceTranscoder;
import com.bokecc.glide.load.resource.transcode.TranscoderRegistry;
import com.bokecc.glide.provider.EncoderRegistry;
import com.bokecc.glide.provider.ImageHeaderParserRegistry;
import com.bokecc.glide.provider.LoadPathCache;
import com.bokecc.glide.provider.ModelToResourceClassCache;
import com.bokecc.glide.provider.ResourceDecoderRegistry;
import com.bokecc.glide.provider.ResourceEncoderRegistry;
import com.bokecc.glide.util.pool.FactoryPools;
...
public class Registry {
  ...
  /**
   * Registers a new {@link Factory} to handle a
