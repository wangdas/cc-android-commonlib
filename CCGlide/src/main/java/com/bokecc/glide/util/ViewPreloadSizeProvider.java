package com.bokecc.glide.util;

import android.support.annotation.NonNull;
import android.support.annotation.Nullable;
import android.view.View;

import com.bokecc.glide.ListPreloader.PreloadSizeProvider;
...
/**
 * A {@link PreloadSizeProvider} that will extract the preload size
 * from a given {@link View}.
 *
 * @param <T> The type of the model the size should be provided for.
 */
public class ViewPreloadSizeProvider<T> implements PreloadSizeProvider<T>,
    SizeReadyCallback {
  private int[] size;
