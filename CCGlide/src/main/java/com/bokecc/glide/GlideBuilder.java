...
import com.bokecc.glide.load.engine.bitmap_recycle.BitmapPoolAdapter;
import com.bokecc.glide.load.engine.bitmap_recycle.LruArrayPool;
import com.bokecc.glide.load.engine.bitmap_recycle.LruBitmapPool;
import com.bokecc.glide.load.engine.cache.DiskCache;
import com.bokecc.glide.load.engine.cache.DiskCache.Factory;
import com.bokecc.glide.load.engine.cache.InternalCacheDiskCacheFactory;
import com.bokecc.glide.load.engine.cache.LruResourceCache;
import com.bokecc.glide.load.engine.cache.MemoryCache;
import com.bokecc.glide.load.engine.cache.MemorySizeCalculator;
import com.bokecc.glide.load.engine.executor.GlideExecutor;
import com.bokecc.glide.load.resource.gif.GifDrawable;
import com.bokecc.glide.manager.ConnectivityMonitorFactory;
import com.bokecc.glide.manager.DefaultConnectivityMonitorFactory;
import com.bokecc.glide.manager.RequestManagerRetriever;
import com.bokecc.glide.manager.RequestManagerRetriever.RequestManagerFactory;
...
public final class GlideBuilder {
  ...
  /**
   * Sets the {@link Factory} implementation to use
